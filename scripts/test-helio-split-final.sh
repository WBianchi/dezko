...
SUBCONTA_PIX="teste@email.com"  # A chave PIX que foi usada para criar a subconta
echo "Usando subconta: $SUBCONTA_NOME (ID: $SUBCONTA_ID, PIX: $SUBCONTA_PIX)"
...
# Criar uma cobrança com split - testando diferentes formatos
echo "Criando cobrança PIX com split para $SUBCONTA_NOME (formato alternativo)..."
