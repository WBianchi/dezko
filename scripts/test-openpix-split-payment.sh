...
# Substitua pelo ID da subconta que vimos na interface
SUBCONTA_ID="Espaço Teste 21:38:03"  
SUBCONTA_EMAIL="teste@email.com"
echo "Usando subconta: $SUBCONTA_ID ($SUBCONTA_EMAIL)"
...
echo "Criando cobrança PIX com split..."
