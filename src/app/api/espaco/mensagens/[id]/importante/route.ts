...
/**
 * PATCH: Marca uma mensagem do espaço como importante
 */
export async function PATCH(
  ...
  try {
    ...
    // Atualiza a mensagem como importante usando SQL raw para evitar problemas com o Prisma
    await prisma.$executeRaw`
      UPDATE "Mensagem"
      SET importante = true, "updatedAt" = NOW()
      WHERE id = ${mensagemId}
    `
